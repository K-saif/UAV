...
## And I would keep AI out initially

This is important for you specifically because you already have a strong computer-vision/AI background.

Don't immediately try:

> YOLO + VLM + RL + SLAM + swarm + LLM 😂

You'll learn much more if you first understand:

**robotics fundamentals → autonomy → perception → planning → multi-agent systems**

Then add your AI/CV expertise where it actually provides value.

Your eventual stack could look like:
...
And because you've already got **PX4 + ROS 2 working**, you're actually at a very good starting point.

### Your immediate next milestone

Don't think about Phase 2 or Phase 3 yet.

Your next goal should simply be:

> **Understand the simulator, spawn one PX4 drone, understand its sensors/state/topics, and manually command it through ROS 2.**

Once you're comfortable with that, we build **Phase 1 → Follow Me**.

That gives you a very clean progression from **"I understand how a simulated drone works" → "I control a drone" → "the drone controls itself" → "multiple drones control themselves together."**
